...
function out = MRSI_convert(data, traj, B0)
    out.data = data;
    out.sz = size(data);
    out.spectralTime = 0:1/traj.sw:1/traj.sw*(traj.spectralLength - 1);
    ...
    affine_matrix = [1, 0, 0, -out.fov.x/2;...
                                             0, 1, 0, out.fov.y/2;...
                                             0, 0, 1, -out.fov.z/2;...
                                             0, 0, 0 , 1];
    affine_matrix = affine_matrix * [out.voxelSize.x, 0         , 0         , 0;...
                         0         , -out.voxelSize.y, 0        , 0;...
                         0         , 0         , out.voxelSize.z, 0;...
                         0         , 0         , 0         , 1];
    out = setAffineMatrix(out, affine_matrix);
    fovX = getFov(out, 'x');
